...
// 3. ARRAY DESTRUCTURING
// ============================================================
const userInfoArray = [true, "John Doe", 30];
...
const newNumbers3 = [4, 6, 7];
const closeFriends = ["Alice", "Bob"];
const allNumbers = [...numbers3, ...newNumbers3];
console.log("All Numbers:", allNumbers);
// Output:
// All Numbers: [1, 2, 3, 4, 6, 7]
// We can also combine arrays:
const allFriends = [...closeFriends, "John", "Sara"];
